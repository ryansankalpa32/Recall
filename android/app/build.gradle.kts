...
android {
    ...
    // fail configuration on machines without one. The single transitive source
    // of a native build was `jni`, pulled in by path_provider_android 2.3.x —
    // pinned back to the 2.2.x line in pubspec.yaml's dependency_overrides.
    ...
    defaultConfig {
        ...
        applicationId = "com.recall.app.recall"
